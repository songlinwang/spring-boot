...
public interface Cat2Repository extends PagingAndSortingRepository<com.wangsonglin.demo4.bean.Cat, Integer>{
	...
	public com.wangsonglin.demo4.bean.Cat findMyCatName(@Param("cn")String catName);
}
